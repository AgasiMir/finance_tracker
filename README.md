...
- **Высокое тестовое покрытие** - 96% покрытие кода тестами
...
После запуска приложения доступны следующие endpoint'ы:
...
Проект имеет высокое тестовое покрытие (96%, подтверждено pytest-cov). Для запуска тестов:
